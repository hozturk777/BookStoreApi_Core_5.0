...
namespace MiddlewarePractices
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //app.Run
            //app.Run(async command => Console.WriteLine("Middleware 1."));
            //app.Run(async command => Console.WriteLine("Middleware 2."));
            ...
            /*app.Use(async (context, next) =>
            {
                ...
                await next.Invoke();
                Console.WriteLine("Middleware 1 Sonland�...");
            });
            ...
            app.Use(async (context, next) =>
            {
                ...
                await next.Invoke();
                Console.WriteLine("Middleware 2 Sonland�...");
            });
            ...
            app.Use(async (context, next) =>
            {
                ...
                await next.Invoke();
                Console.WriteLine("Middleware 3 Sonland�...");
            });*/
